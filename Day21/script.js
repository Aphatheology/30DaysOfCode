...
let quizQuestions = [
...

    {
        ...
        options: ["Boolean" , "Undefine" ,  "Object" , "NaN" ] ,
        correctAnswer: 3
    } ,

    {
        question: "Which company developed JavaScript?" ,
        options: [  "Netscape" ,'Framework.js' , "Microsoft" ,  "npm" ] ,
        correctAnswer: 0
    } ,

    {
        question: "Which one is not a type of pop up in Javascript?" ,
        options: ["alert" , "confirm" , "aware" ,  "prompt" ] ,
        correctAnswer: 2
    }
]
